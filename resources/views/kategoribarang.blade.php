...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Tabel Kategori Barang</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="index.html">Kategori Barang</a></li>
                        ...
                        <tr>
                            ...
                            @foreach ($kategori_barangs as $d)
                                ...
                                <td>
                                    ...
                                    <a href="/barang/kategori/hapus/{{ $d->id }}"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ route('updatekategoribarang') }}">
                                            @csrf
                                            <div class="mb-3">
...
<div class="modal fade" id="addmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('simpankategoribarang') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="nama_kategori" class="form-label">Nama Kategori</label>
