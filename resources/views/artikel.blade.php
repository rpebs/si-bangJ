...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Tabel Artikel</h1>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{ route('updateartikel') }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="post" id="y"
                                                        value="{{ $p->post }}">
...
<div class="modal fade" id="addmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('simpanartikel') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="judul" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" id="judul"
...
<script>
    ...
    judul.addEventListener('keyup', function() {
        ...
        fetch('/x/post/artikel?judul=' + judul.value)
